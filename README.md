...
You should now have an instance at `https://github.com/USER_OR_ORG/YOUR_REPO_NAME`
...
3. The actions defined in `.github/workflows` will be executed by GitHub. Once a first build is complete, it will create a separate branch called `gh-pages`. Enable deployment to GitHub Pages by assigning branch `gh-pages` and `root` as the directory in your repo's GitHub Pages settings:
